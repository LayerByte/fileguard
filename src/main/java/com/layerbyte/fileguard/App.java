package com.layerbyte.fileguard;
...
public final class App {
    private static final String PROJECT_NAME = "Fileguard";
    private static final String PROJECT_FOCUS = "Directory integrity monitor.";
